...
ANTIZAPRET_PARAMS = [
    ...
    },
    {
        ...
        "type": "flag",
        "default": "n",
        "html_id": "WARP_OUTBOUND-toggle",
        "title": "Cloudflare WARP for all VPN",
        "description": "Включающая отправку всего исходящего впн трафика не напрямую с VPN сервера а через Cloudflare WARP",
    },
    {
        "key": "ssh_protection",
        "env": "SSH_PROTECTION",
    ...
    },
    {
        ...
        "title": "Антискан и защита от атак",
        "description": "Внимание!!! Защита от сетевых атак и сканирования может блокировать VPN или сторонние приложения!",
    },
    {
        "key": "torrent_guard",
        "env": "TORRENT_GUARD",
